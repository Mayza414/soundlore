...
export default function Sidebar({ genres, isOpen, onClose }: SidebarProps) {
    ...
    <>
      ...
      <ul className="flex flex-col gap-2">
        {genres.map((genre) => {
          ...
          const isActive = url === `/generos/${genre.slug}`;
  ...
  return (
    <>
      <nav className="fixed left-0 top-20 h-[calc(100vh-80px)] w-72 bg-surface-container shadow-2xl flex-col p-8 z-40 hidden md:flex border-r border-surface-container-high overflow-y-auto">
        {content}
      </nav>
